...
#define PID_KI 6.0f     // He so tich phan (Integral) - giam do update nhanh hon
#define PID_KD 0.00001f // He so vi phan (Derivative)

// Thoi gian loc (filter time) cho dao ham
#define PID_TAU 0.01f   // Giam tau cho phu hop voi 1ms sampling
...
#define SAMPLE_TIME_S 0.001f    // 1000us sampling
